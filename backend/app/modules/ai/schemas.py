...
class AiModel(BaseModel):
    ...
    tier: str = Field(default="balanced", description="Capability tier: frontier, balanced or fast")
    supports_vision: bool = Field(default=False, description="Whether model accepts image input")
    supports_tools: bool = Field(default=True, description="Whether model supports tool calling")
    supports_reasoning: bool = Field(default=False, description="Whether model exposes extended reasoning")
