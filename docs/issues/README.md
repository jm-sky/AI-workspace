...
| 007 | [2026-07-09--007--audit-sheet-no-padding.md](2026-07-09--007--audit-sheet-no-padding.md) | Audyt/Trace (sheet) — brak paddingu treści | `todo` |
| 008 | [2026-07-09--008--memory-page-no-canvas-background.md](2026-07-09--008--memory-page-no-canvas-background.md) | Strona Pamięci — brak tła (canvas) | `todo` |
