...
| P2 | [#016](2026-07-10--016--model-picker-performance.md) | Model picker performance | `in progress` — nie blokuje P0/P1 |
| P3 | [#005](2026-07-07--005--guest-layout-nav-z-index.md) | Guest layout z-index | drobnica UI |
...
| 016 | [2026-07-10--016--model-picker-performance.md](2026-07-10--016--model-picker-performance.md) | Model picker — wydajność otwarcia (lazy load) | `in progress` |
